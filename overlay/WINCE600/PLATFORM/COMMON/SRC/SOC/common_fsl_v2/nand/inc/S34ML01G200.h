...
//  File:  NAND01GW3B2C.h
//
//  Contains definitions for FMD impletation of the Numonyx NAND01GW3B2CN6E NAND
//  flash memory device.
//
//------------------------------------------------------------------------------
#ifndef __NAND01GW3B2C_H__
#define __NAND01GW3B2C_H__
...
#define BBI_NUM                 (2)         // Only one page contains bad block infos
BYTE    BBMarkPage[1] = {0,1};                // The first page in the block (offset 0) contains bad block info

#endif    // __NAND01GW3B2C_H__
