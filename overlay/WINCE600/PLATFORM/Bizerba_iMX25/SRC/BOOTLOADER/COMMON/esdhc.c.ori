...
void SDConfigPins (void)
{
    ...
    OAL_IOMUX_SET_PAD(g_pIOMUX, DDK_IOMUX_PAD_SD1_CLK, DDK_IOMUX_PAD_SLEW_SLOW, DDK_IOMUX_PAD_DRIVE_NORMAL, DDK_IOMUX_PAD_OPENDRAIN_DISABLE,
                                    DDK_IOMUX_PAD_PULL_UP_22K, DDK_IOMUX_PAD_HYSTERESIS_DISABLE, DDK_IOMUX_PAD_VOLTAGE_3V3);
    ...
    OAL_IOMUX_SET_PAD(g_pIOMUX, DDK_IOMUX_PAD_SD1_DATA3, DDK_IOMUX_PAD_SLEW_FAST, DDK_IOMUX_PAD_DRIVE_HIGH, DDK_IOMUX_PAD_OPENDRAIN_DISABLE, DDK_IOMUX_PAD_PULL_UP_47K, DDK_IOMUX_PAD_HYSTERESIS_ENABLE, DDK_IOMUX_PAD_VOLTAGE_3V3);
}
...
static void SDHCCmdConfig(PSD_BUS_REQUEST pReq)                                                           
{
    ...
    if (TransferClass != SD_COMMAND)
    {
        ...
        INSREG32BF(&g_pESDHCReg->PROCTL, ESDHC_PROCTL_DTW, SDController.BusWidthSetting);
